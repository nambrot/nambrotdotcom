...
(function() {
  ...
  queueReducer = function(state, action) {
    var addToCache, cacheVideo, hideVideo, id, indexOf, newId, newState, nextId, showVideo, timeout;
    if (state == null) {
      state = {
        queue: [],
        preloadCache: {},
    ...
    addToCache = function(preloadCache, id) {
      var obj;
      return Object.assign({}, preloadCache, (
        obj = {},
        obj["" + id] = {
          ytPlayer: cacheVideo(id)
        },
        obj
      ));
    };
      ...
      case 'PRELOAD_VIDEO':
        if (state.preloadCache[action.id]) {
          ...
          newState = Object.assign({}, state, {
            preloadCache: addToCache(state.preloadCache, id)
          });
          return newState;
        }
        break;
