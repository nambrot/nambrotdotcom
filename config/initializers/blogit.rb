...
Blogit.configure do |config|
  ...
  config.rss_feed_title = "Blog by Nam Chu Hoai"

  # RSS Feed description content
  config.rss_feed_description = "Straight out of the life of Nam Chu Hoai"
